...
namespace Joagraphic.App_Code.Security
{
	...
	public class ESUsuario
	{
		...
		{
			int intUsuario = 0;
			intUsuario = Convert.ToInt32(SqlHelper.ExecuteScalar(ESSeguridad.FormarStringConexion(), Queries.WF_Login, Usuario, Password));
		...
		public static ESColeccionUsuario ListarUsuarios(string strBusqueda, short shtLoS, short shtEstatus, short shtOficina)
		{
			...
			DataSet ds = SqlHelper.ExecuteDataset(ESSeguridad.FormarStringConexion(),Queries.WF_ListarUsuarios,strBusqueda,shtLoS,shtEstatus,shtOficina); 
