...
namespace Joagraphic.DesktopModules.Workflow
{
	...
	public partial class IntroNuevoWorkflow : System.Web.UI.UserControl, WFIEditarControlWorkflow
	{
		...
		public bool Update() 
		{
			if (chkSkip.Checked) 
			{
                Response.Cookies[Web.Global.SkipWorkflowIntro].Value = "1";
                Response.Cookies[Web.Global.SkipWorkflowIntro].Path = "/";
                Response.Cookies[Web.Global.SkipWorkflowIntro].Expires = DateTime.MaxValue;
