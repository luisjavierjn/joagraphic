...
using Joagraphic.App_Code.Inbox;
using Joagraphic.App_Code.Workflow;

namespace Joagraphic.DesktopModules.Inbox
{
    public partial class WizardInbox : System.Web.UI.UserControl, WFIEditarStatusWF
    {
        ...
        {
            hfIdUser.Value = Session["IDUsuario"].ToString();
            ...
            {
                _wizardSteps.Add("DesktopModules/Inbox/GridPrincipal.ascx");
                _wizardSteps.Add("DesktopModules/Inbox/OperacionExitosa.ascx");
                _wizardSteps.Add("DesktopModules/Inbox/ControlDePagos.ascx");
                _wizardSteps.Add("DesktopModules/Inbox/PantallaPedidos.ascx");
                _wizardSteps.Add("DesktopModules/Inbox/SublimacionPedidos.ascx");
            }
        ...
        public void LoadWizardStep()
        {
            ...
            if (hfSource.Value == "0") // GridPrincipal u OperacionExitosa
            {
            ...
            else if (hfSource.Value == "1") // 1 es formulario desde GridPrincipal contiene información
            {
        ...
        {
            ddlRechazo.DataSource = WFMotivosRechazo.ListarMotivosRechazo();
        ...
        {            
            CtrlIndex = 0; // cargar GridPrincipal
        ...
        public int IdPH(int idPH, int wfId, int creadorId, string status)
        {
            ...
            if (Convert.ToInt32(hfIdUser.Value) == creadorId && (status == "Por corregir" || status == "Creado"))
                ...
                hfSource.Value = "1"; // 1 es formulario desde GridPrincipal contiene información
