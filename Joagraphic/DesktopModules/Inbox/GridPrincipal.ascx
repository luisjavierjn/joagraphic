<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GridPrincipal.ascx.cs" Inherits="Joagraphic.DesktopModules.Inbox.GridPrincipal" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" RowStyle-CssClass="Gridview_cuerpo"
    ...
    DataKeyNames="ReferenciaId, WorkFlowId, ResponsableId, IdStatus" AllowSorting="True" 
    OnSelectedIndexChanged="GridView1_SelectedIndexChanged" EmptyDataRowStyle-CssClass="Gridview_cuerpo" 
    EnableViewState="False" Width="100%" PageSize="50"
    ShowFooter="False">
