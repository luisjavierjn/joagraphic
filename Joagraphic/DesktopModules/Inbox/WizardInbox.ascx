<%@ Control Language="C#" AutoEventWireup="true" CodeFile="WizardInbox.ascx.cs" Inherits="Joagraphic.DesktopModules.Inbox.WizardInbox" %>
...
<table id="main" cellspacing="0" cellpadding="0" border="0" style="width: 100%">
    <tr valign="top">
        <td class="SubHead" style="width: 20%">
        ...
        <td class="style6" style="width: 80%">
            <fieldset>
                <legend class="EtiquetaNormal"></legend>
                <br />
                                ...
                                <tr>
                                    ...
                                    <td class="style2" align="center">
                                        <asp:DropDownList ID="DropDownList1" runat="server" Style="margin-left: 0px" Width="150px"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddlPH_SelectedIndexChanged" CssClass="ComboNormal">
                        ...
                        <table>
                            <tr>
                                ...
                                <td align="center" id="BtnEnviarId">
                                    <asp:Button ID="BtnEnviar" runat="server" Visible="false" Text="Salvar y Enviar"
                                        OnClick="BtnEnviar_Click" Width="141px"></asp:Button>
                                </td>
