<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SublimacionPedidos.ascx.cs" Inherits="Joagraphic.DesktopModules.Inbox.SublimacionPedidos" %>
...
<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" RowStyle-CssClass="Gridview_cuerpo"
    OnRowCreated="OrderGridView_RowCreated" OnRowDataBound="GridView1_RowDataBound"
    OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging"
    AllowSorting="True" OnSorting="GridView1_Sorting" Width="690px" DataKeyNames="TransaccionId"
    EmptyDataText="No se han registrado instrumentos  de este tipo" EmptyDataRowStyle-CssClass="Gridview_cuerpo"
    EnableViewState="False" ShowFooter="True">
    <RowStyle CssClass="Gridview_cuerpo"></RowStyle>
    <Columns>
        <asp:BoundField DataField="Cusip" HeaderText="Cusip" SortExpression="Cusip" FooterText="TOTAL"
            FooterStyle-CssClass="Gridview_cuerpo" FooterStyle-VerticalAlign="Middle" FooterStyle-BorderWidth="0"
            ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="Instrumento" HeaderText="Instrumento" SortExpression="Instrumento"
            FooterStyle-BorderWidth="0" ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="FechaVenc" HeaderText="FechaVenc" DataFormatString="{0:dd/MM/yyyy}"
            HtmlEncode="false" SortExpression="FechaVenc" FooterStyle-BorderWidth="0" ItemStyle-BorderColor="Gray"
            ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="Facial" HeaderText="Facial" SortExpression="Facial" FooterStyle-BorderWidth="0"
            ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="Cupon" HeaderText="Cupon" SortExpression="Cupon" FooterStyle-BorderWidth="0"
            ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="Moneda" HeaderText="Div" SortExpression="Moneda" FooterStyle-BorderWidth="0"
            ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="Cant" HeaderText="Cant" SortExpression="Cantidad" FooterStyle-BorderWidth="0"
            ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="PrecioActual" HeaderText="Precio Actual" SortExpression="PrecioActual"
            FooterStyle-BorderWidth="0" ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="IA" HeaderText="IA" SortExpression="IA" FooterStyle-BorderWidth="0"
            ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:BoundField DataField="TC" HeaderText="TC" SortExpression="TC" FooterStyle-BorderWidth="0"
            ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1">
            <HeaderStyle CssClass="Gridview_cabecera" />
        </asp:BoundField>
        <asp:TemplateField HeaderText="Valor" HeaderStyle-CssClass="Gridview_cabecera" FooterStyle-CssClass="Gridview_cuerpo"
            ItemStyle-HorizontalAlign="Center" ItemStyle-BorderColor="Gray" ItemStyle-BorderWidth="1"
            FooterStyle-HorizontalAlign="Center">
            <ItemTemplate>
                <%#Eval("Valoracion", "{0:}")%>
            </ItemTemplate>
            <FooterTemplate>
                <asp:Label ID="OrderTotalLabel" runat="server" CssClass="Gridview_cuerpo" />
            </FooterTemplate>
            <FooterStyle HorizontalAlign="Center" Wrap="True" CssClass="Gridview_cuerpo"></FooterStyle>
            <HeaderStyle CssClass="Gridview_cabecera"></HeaderStyle>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        ...
        <table style="width: 640px;" cellspacing="1" cellpadding="1" border="1" class="NormalOperaciones">
            <tr>
            ...
            <tr>
                ...
                <td class="style2">
                    <div style="width: 178px">
                        ...
                        <asp:ImageButton ID="ibCalendario" runat="server" ImageUrl="~/images/Calendario.png" />
                    </div>
                </td>
                <td>
